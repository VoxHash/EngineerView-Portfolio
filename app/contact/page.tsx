          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl bg-neutral-100 dark:bg-neutral-800 px-4 py-3 border border-neutral-200 dark:border-neutral-700 focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full rounded-xl bg-neutral-100 dark:bg-neutral-800 px-4 py-3 border border-neutral-200 dark:border-neutral-700 focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors resize-none"
            ...
            <button
              ...
              className="w-full btn hover-glow flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
